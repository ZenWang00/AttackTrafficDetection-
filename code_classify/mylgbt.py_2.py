...
params={
    ...
    'num_class':2,  #lightgbm.basic.LightGBMError: b‘Number of classes should be specified and greater than 1 for multiclass training‘
}
...
fpr, tpr, thresholds = roc_curve(label_test, y_pred, pos_label=2)
auc = auc(label_test, y_pred)
print("\nModel report")
print(auc)
